 ...
 * Time  20:32
 */
public class ConcurrentHashMapCacheUtilsInMemory {
//    private static Logger LOGGER = LoggerFactory.getLogger(ConcurrentHashMapCacheUtils.class);
     ...
     * 时间30分钟
     */
    public static final Long THIRTY_MINUTE = 30 * 1000L;
    /**
     * 时间5分钟
     */
    ...
    public static void setCache(String cacheKey, Object cacheValue, long cacheTime) {
        ...
        System.out.print("have set key :" + cacheKey);
    }
    ...
    public static void clear() {
        System.out.print("have clean all key !");
    ...
    public static void deleteCache(String cacheKey) {
        ...
        if (cacheValue != null) {
            System.out.print("have delete key :" + cacheKey);
            CURRENT_SIZE = CURRENT_SIZE - 1;
        }
    }
    ...
    private static void deleteLRU() {
        System.out.print("delete Least recently used run!");
    ...
    static void deleteTimeOut() {
        System.out.print("delete time out run!");
        ...
        System.out.print("delete cache count is :" + deleteKeyList.size());
    }
    ...
    private static void startCleanThread() {
        if (!CLEAN_THREAD_IS_RUN) {
            CleanTimeOutThreadInMemory cleanTimeOutThread = new CleanTimeOutThreadInMemory();
...
class CacheObjInMemory {
    ...
    CacheObjInMemory(Object cacheValue, Long ttlTime) {
 ...
 * 每一分钟清理一次过期缓存
 */
class CleanTimeOutThreadInMemory implements Runnable {
